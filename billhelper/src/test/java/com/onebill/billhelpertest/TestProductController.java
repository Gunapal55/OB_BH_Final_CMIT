//package com.onebill.billhelpertest;
//
//
...
//		requestParams.put("productName", "Vogo ridez");
//		requestParams.put("productType", "Scooter Rental");
//
//		request.header("Content-Type", "application/json");
//		request.body(requestParams.toJSONString());
//
//		Response response = request.post("/billhelper/products");
...
//		Response response = get("/productbilling/products/product/AT&T");
//		int statusCode = response.getStatusCode();
//		Assert.assertEquals(statusCode, 200);
//	}
//
...
//		requestParams.put("productName", "AT&T");
